"""
Usage:
(zehao): python scripts_real/eval_pika.py -i data/outputs/2023.10.26/02.25.30_train_diffusion_unet_timm_umi/checkpoints/latest.ckpt -o data_local/cup_test_data
...
def apply_gripper_width_rule(action, close_threshold=0.055, close_delta=0.01):
